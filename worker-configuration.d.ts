/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 35c1fcdfca6c07fa7fc65ff6d6d23644)
// Runtime types generated with workerd@1.20251202.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DataProcessor";
	}
	interface Env {
		WORKER_LOG_URL: "https://sgd-hbd-data.hacolby.workers.dev/_internal/log";
		R2_BUCKET_NAME: string;
		R2_ACCOUNT_ID: string;
		AWS_ACCESS_KEY_ID: string;
		AWS_SECRET_ACCESS_KEY: string;
		DataProcessor: DurableObjectNamespace<import("./src/index").DataProcessor>;
		BUCKET: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_LOG_URL" | "R2_BUCKET_NAME" | "R2_ACCOUNT_ID" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY">> {}
}
