...
from src.db_models import RawSgEatingEstablishments
...
def normalize_record(record: Dict[str, Any], dataset_name: str = 'sg_eating_establishments', ingested_at: str = None) -> RawSgEatingEstablishments:
    # --- Geo Extraction ---
    ...
    return RawSgEatingEstablishments(
        id=record_id,
