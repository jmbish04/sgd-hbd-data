...
from src.db_models import RawSgCyclingNetwork
...
def normalize_record(record: Dict[str, Any], dataset_name: str = 'sg_cycling_network', ingested_at: str = None) -> RawSgCyclingNetwork:
    # --- Geo Extraction ---
