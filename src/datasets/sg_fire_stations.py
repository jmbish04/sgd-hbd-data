...
from src.db_models import RawSgFireStations
...
def normalize_record(record: Dict[str, Any], dataset_name: str = 'sg_fire_stations', ingested_at: str = None) -> RawSgFireStations:
    # --- Geo Extraction ---
