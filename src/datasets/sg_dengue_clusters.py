...
from src.db_models import RawSgDengueClusters
...
def normalize_record(record: Dict[str, Any], dataset_name: str = 'sg_dengue_clusters', ingested_at: str = None) -> RawSgDengueClusters:
    # --- Geo Extraction ---
    ...
    return RawSgDengueClusters(
        ...
        gpr=record.get('GPR'),
        whiteQMx=record.get('WHITE_Q_MX'),
        gprBMin=record.get('GPR_B_MIN'),
