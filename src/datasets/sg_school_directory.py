...
from src.db_models import RawSgSchoolDirectory
...
def normalize_record(record: Dict[str, Any], dataset_name: str = 'sg_school_directory', ingested_at: str = None) -> RawSgSchoolDirectory:
    # --- Geo Extraction ---
