...
from src.db_models import RawSgSupermarkets
...
def normalize_record(record: Dict[str, Any], dataset_name: str = 'sg_supermarkets', ingested_at: str = None) -> RawSgSupermarkets:
    # --- Geo Extraction ---
