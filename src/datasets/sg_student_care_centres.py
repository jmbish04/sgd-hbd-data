...
from src.db_models import RawSgStudentCareCentres
...
def normalize_record(record: Dict[str, Any], dataset_name: str = 'sg_student_care_centres', ingested_at: str = None) -> RawSgStudentCareCentres:
    # --- Geo Extraction ---
    ...
    return RawSgStudentCareCentres(
        id=record_id,
