...
from src.db_models import RawSgPublicLibraries
...
def normalize_record(record: Dict[str, Any], dataset_name: str = 'sg_public_libraries', ingested_at: str = None) -> RawSgPublicLibraries:
    # --- Geo Extraction ---
