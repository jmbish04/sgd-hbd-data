...
from src.db_models import RawSgChasClinics
...
def normalize_record(record: Dict[str, Any], dataset_name: str = 'sg_chas_clinics', ingested_at: str = None) -> RawSgChasClinics:
    # --- Geo Extraction ---
